...
public class FundTrade extends Trade {
    ...
    private MallonExchange mallonExchange;
    ...
    public MallonExchange getMallonExchange() {
        return this.getMallonExchange();
    }

    public void setMallonExchange(MallonExchange newMallonExchange) {
        this.mallonExchange = newMallonExchange;
